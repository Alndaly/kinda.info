...
const zh = {
  ...
  about: {
    ...
    wechatPersonal: '加我微信',
    wechatPersonalKicker: 'WeChat · 直接联系',
    wechatPersonalDescription: '想聊具体的事、或者想一起做点什么，扫码加我，附一句来意就好。',
    wechatPersonalAlt: '七月的个人微信二维码',
    wechat: '微信公众号',
...
const en = {
  ...
  about: {
    ...
    wechatPersonal: 'Add me on WeChat',
    wechatPersonalKicker: 'WeChat · Direct',
    wechatPersonalDescription: 'Scan to add me. If you have something specific in mind, a line about it is all I need.',
    wechatPersonalAlt: 'Personal WeChat QR code for Kinda',
