...
const zh = {
  ...
  notes: {
    ...
    previous: '上一篇',
    next: '下一篇',
    fallbackTitle: '这篇文章暂时只有中文版本',
    fallbackDescription: '页面导航保持英文，正文展示原始中文内容。',
    viewOriginal: '打开中文原文',
  },
  photography: {
    title: '暗房',
...
const en = {
  ...
  notes: {
    ...
    tagIndex: 'Tag index',
    originalLanguage: 'Chinese original',
    result: 'entry',
    results: 'entries',
    ...
    previous: 'Previous',
    next: 'Next',
    fallbackTitle: 'This note is currently available in Chinese only',
    fallbackDescription: 'Navigation remains in English while the original Chinese text is shown.',
    viewOriginal: 'Open Chinese original',
  },
  photography: {
    title: 'Darkroom',
