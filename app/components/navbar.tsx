...
export default function Navbar() {
	...
	return (
		<header
			...
			} py-3 sticky z-10 bg-white dark:bg-[#1E1E1E] backdrop-filter backdrop-blur-lg bg-opacity-[78.6%] border-b border-zinc-50 dark:border-zinc-800 px-4 transition-top duration-600 transform`}>
